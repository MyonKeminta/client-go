...
func (s *testClientFailSuite) TestPanicInRecvLoop(c *C) {
	c.Assert(failpoint.Enable("github.com/tikv/client-go/v2/client/panicInFailPendingRequests", `panic`), IsNil)
	c.Assert(failpoint.Enable("github.com/tikv/client-go/v2/client/gotErrorInRecvLoop", `return("0")`), IsNil)
	...
	c.Assert(failpoint.Disable("github.com/tikv/client-go/v2/client/gotErrorInRecvLoop"), IsNil)
	c.Assert(failpoint.Disable("github.com/tikv/client-go/v2/client/panicInFailPendingRequests"), IsNil)
